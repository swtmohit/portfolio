    ...
    >
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-6xl mx-auto">
          <motion.p
            className={`text-lg font-semibold leading-relaxed mb-6 text-center ${textSecondary}`}
            variants={itemVariants}
          >
          ...
          <div className="flex flex-col md:flex-row gap-8 mt-16">
            ...
            >
              <div className="relative md:block hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-xl blur-lg opacity-40 transition-opacity duration-500" style={{ transform: 'translateX(-100px)' }}></div>
                <motion.img
                  src="/2.png"
                  alt="Framed Image 1"
                  className="w-72 h-72 object-cover rounded-xl shadow-2xl relative z-10 border border-white/20 dark:border-slate-700/50"
                  style={{ transform: 'translateX(-100px)' }}
                />
              </div>
              <div className="relative md:hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-xl blur-lg opacity-40 transition-opacity duration-500 mx-auto w-64 h-64"></div>
                <motion.img
                  src="/2.png"
                  alt="Framed Image 1"
                  className="w-64 h-64 object-cover rounded-xl shadow-2xl relative z-10 border border-white/20 dark:border-slate-700/50 mx-auto"
                />
              </div>
              <div className="relative md:block hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-xl blur-lg opacity-40 transition-opacity duration-500" style={{ transform: 'translateX(60px)' }}></div>
                <motion.img
                  src="/3.png"
                  alt="Framed Image 2"
                  className="w-72 h-72 object-cover rounded-xl shadow-2xl relative z-10 border border-white/20 dark:border-slate-700/50"
              ...
              <div className="relative md:hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-xl blur-lg opacity-40 transition-opacity duration-500 mx-auto w-64 h-64"></div>
                <motion.img
                  src="/3.png"
                  alt="Framed Image 2"
                  className="w-64 h-64 object-cover rounded-xl shadow-2xl relative z-10 border border-white/20 dark:border-slate-700/50 mx-auto"
